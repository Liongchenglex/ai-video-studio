      ...
      scenes: {
        ...
        items: {
          ...
          properties: {
            ...
            still_image_prompt: { type: "string", description: "The FIRST visual the viewer sees when this scene begins — a single frozen moment, not a summary of the whole scene. Describe ONE specific, concrete image: a particular object, person, or place in a specific state. Include composition (wide shot, close-up, bird's eye), dominant colors, lighting, and mood. NO motion words (no 'transition', 'pan', 'zoom', 'moves'). NO abstract concepts — describe what a camera would photograph at the START of this scene. Example: 'A grand imperial throne room with towering red lacquer pillars, a golden dragon throne gleaming under torchlight, silk banners hanging motionless, polished marble floor reflecting amber light, symmetrical composition, warm gold and crimson palette'" },
